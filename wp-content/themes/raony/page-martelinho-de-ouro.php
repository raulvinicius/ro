		...
		<section id="mini-galeria" class="cor-mestre">
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<p class="col-md-4 col-sm-offset-4">Dê uma olhada em alguns trabalhos concluídos e entenda melhor como nosso processo artesanal faz toda a diferença.</p>
